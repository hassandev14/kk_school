            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="page-content-wrapper ">
                        ...
                        <form action="<?php echo e(url('add_exam')); ?>" style="border:1px solid #ccc" enctype="multipart/form-data" method="POST">
                        <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="form-horizontal" role="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <input type="text" class="form-control" value="<?php echo e($data->class_name); ?>"readonly>  
                                                    <input type="hidden" class="form-control" value="<?php echo e($data->id); ?>" id="class_id" name="class_id"> 
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\kk_school\resources\views/add_exam.blade.php ENDPATH**/ ?>