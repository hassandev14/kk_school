        ...
        <script src="<?php echo e(url('/')); ?>/assets/pages/dashborad.js"></script>

        <script src="<?php echo e(url('/')); ?>/assets/js/app.js"></script>

    </body>

<!-- Mirrored from themesdesign.in/appzia/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jan 2022 11:07:51 GMT -->
</html><?php /**PATH D:\wamp\www\kk_school\resources\views/includes/footer.blade.php ENDPATH**/ ?>