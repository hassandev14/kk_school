...
<?php endif; ?>
                                        <div class="card-body">
                                            ...
                                            <form action="<?php echo e(url('student_fee_save_paid')); ?>" class="form-horizontal" role="form" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\kk_school\resources\views/add_students_fee.blade.php ENDPATH**/ ?>