                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="joining_date" value="<?php echo e($data->joining_date); ?> <?php echo e(old('joining_date')); ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <option>Select Gender</option>
                                                            <option  value="<?php echo e($data->men); ?> <?php echo e(old('men')); ?>">Men</option>
                                                            <option  value="<?php echo e($data->women); ?> <?php echo e(old('women')); ?>">Women</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
